    ...
    await axios
      .post(
        "https://uuj7unf2r3.execute-api.us-east-2.amazonaws.com/create-checkout-session",
        {
          ...
          mode: "payment",
          success_url: "ttps://www.conjoveneslegado.com/pago-exitoso", //"https://www.conjoveneslegado.com/pago-exitoso", // * Redigir a frontend, y enviar correo (ver flujo después)
