  ...
  >
    <Container>
      <Grid container spacing={1} alignItems="center">
        {/* Lado izquierdo */}
        <Grid item xs={12} md={4} sx={{ paddingLeft: 0, textAlign: 'center' }}>
          <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', justifyContent: 'center' }}>
            <Card orientation="vertical" variant="outlined" sx={{ width: 150, marginRight: { md: 2 }, mx: 'auto' }}>
              <CardOverflow>
            ...
            <Typography level="h4" sx={{ mt: { xs: 1, md: 0 }, textAlign: 'center', flex: 1 }}>
              Regístrate en el Congreso <strong>Legado</strong> <Link to="/registro">aquí</Link>
            </Typography>
          </Box>
        </Grid>
  
        {/* Divider */}
        <Grid item md={2} sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center' }}>
